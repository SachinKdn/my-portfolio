...
import proj1 from "/public/images/projects/ai-or-not.png";
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            ...
            >
              <h2 className="mb-4 text-2xl font-bold capitalize text-dark/75 dark:text-light/75">
                Detect AI-generated images, text, music, deepfakes and video for your business - and yourself - with AI or Not
              </h2>
              <h3 className="mb-4 text-lg font-bold  text-lightGreen dark:text-primaryDark">
                NextJs | Tailwind CSS | Framer Motion | SEO | Lighthouse
              </h3>
              <div classNname="w-full border-2 border-solid border-light bg-light"></div>
              <p className="">
                I worked on this project as a Frontend Developer, where I also led the frontend team. My responsibilities included managing API integrations, implementing animations to enhance user experience, and ensuring SEO optimization along with adhering to Lighthouse performance best practices.
              </p>
              <h4 className="mt-4 text-lg font-800 capitalize text-dark/75 dark:text-light/75">
                Integrated the StoryBlok CMS (Content Management System):
              </h4>
              <p className="mt-2">
                I also integrated a content management system (CMS) into the project, enabling non-technical users to easily publish and manage blogs and news on the portal.
              </p>
              <h4 className="mt-4 text-lg font-800 capitalize text-dark/75 dark:text-light/75">
                Implementations:
              </h4>
              ...
              <span className="mt-1">⦿ Framer Motion Animations</span>
              <span className="mt-1">⦿ AWS Amplify Authentication</span>
              <span className="mt-1">⦿ SEO</span>
              <span className="mt-1">⦿ StoryBlok CMS</span>
              <span className="mt-1 mb-4">⦿ Lighthouse</span>
